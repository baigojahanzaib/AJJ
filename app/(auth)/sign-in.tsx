...
export default function SignInScreen() {
  ...
  useEffect(() => {
    if (!authLoading && isAuthenticated && user) {
      ...
      } else if (user.role === 'sales_rep' || (user.role === 'admin' && isViewingAsUser)) {
  ...
  if (authLoading || (isAuthenticated && user)) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>{authLoading ? 'Loading...' : 'Redirecting...'}</Text>
      </View>
    );
  }
      ...
      >
        ...
        >
          ...
          <View style={styles.form}>
            ...
            <TouchableOpacity style={styles.createAccountButton} onPress={() => router.push('/(auth)/sign-up' as any)}>
              <Text style={styles.createAccountText}>New client? Create an account</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
